...
- Download and unzip precomputed_data from [here](https://github.com/ChantalMP/EHR2Path/releases/download/data/precomputed_data.zip) and place all contents in your mimiciv_path folder (e.g. /data/mimiciv/).
- This data includes:
...
- Download and unzip all needed pre-trained model weights from [here](https://github.com/ChantalMP/EHR2Path/releases/tag/data) and place them in the `outputs` folder.
