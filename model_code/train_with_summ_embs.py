...
if __name__ == '__main__':
    ...
    if config['dataset_config']['dataset_name'] == "summary": #training summarizer model
        ...
        dataset_callback_eval = SummaryDataset(tokenizer=tokenizer, split=val_split, max_input_len=config['dataset_config']['max_input_len'],
                                            ...
                                            model_name=config['training_config']['model_name'],
                                            custom_attn_mask=config['model_config']['use_custom_attn'])
    elif config['dataset_config']['dataset_name'] == "mixed": #summary only or summary + text
    ...
    if config['training_config']['resume_from_model'] and not config['training_config']['resume_from_checkpoint']:
        print("Starting from curriculum checkpoint")
